...
const PLATFORMS = [
  ...
  { name:"One Submit", cat:"Promotion", color:"#4CAF7A", icon:"✅", desc:"Submit to Spotify playlists, YouTube channels, and TikTok influencers in one place. Credit-based system.", url:"https://one-submit.com/", tags:["Multi-platform","TikTok","Credit-based"] },
  ...
  { name:"Artlist", cat:"Licensing", color:"#2563EB", icon:"🎞️", desc:"License your music to 25M+ content creators worldwide. Revenue share model.", url:"https://artlist.io/", tags:["25M+ creators","Revenue share","Application review"] },
  { name:"Epidemic Sound", cat:"Licensing", color:"#FF4444", icon:"🔈", desc:"Partner program for sync licensing. Catalog buy-out model — they own future rights after deal.", url:"https://epidemicsound.com/", tags:["YouTube creators","Buy-out model","Brand deals"] },
  { name:"Pond5", cat:"Licensing", color:"#00B4D8", icon:"🌊", desc:"Marketplace for music, video, and SFX. Set your own prices and keep 35–50%.", url:"https://pond5.com/", tags:["Self-priced","Production music","35–50% cut"] },
  { name:"Musicosmos", cat:"Licensing", color:"#A29BFE", icon:"🌌", desc:"Sync licensing platform connecting independent artists to film, TV, and ad placements.", url:"https://musicosmos.com.br/", tags:["Indie-friendly","Film & ads","Rights-managed"] },
  ...
  { name:"Songkick for Artists", cat:"Live", color:"#F80046", icon:"🎤", desc:"Claim your artist profile to list concerts and reach fans who track you.", url:"https://www.songkick.com/", tags:["Free","Concert listings","Fan tracking"] },
  ...
  { name:"Gigsster", cat:"Live", color:"#74B9FF", icon:"🏛️", desc:"Venue marketplace for booking event spaces and connecting with promoters.", url:"https://giggster.com/", tags:["Venue booking","Self-produced shows","Promoter network"] },
